...
namespace MVCAbelStoreData
{
    public class Product : EntityBase
    {
        ...
        public string ImageSrc => ProductImages.Any() ? $"data:image/jpeg;base64, {Convert.ToBase64String(ProductImages.First().Image)}" : "/Images/resim-yok.jpg";

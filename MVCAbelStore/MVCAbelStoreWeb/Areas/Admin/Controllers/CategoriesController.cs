    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create(Category model)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["error"] = "Aynı isimli başka bir Kategori bulunduğu için eklenememiştir!";
                return View(model);
            }
        ...
        public async Task<IActionResult> Edit(Category model)
        {
            ...
            {
                await context.SaveChangesAsync();
                TempData["success"] = "Kategori düzenleme işlemi başarıyla tamamlanmıştır.";
                return RedirectToAction(nameof(Index));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Remove(Guid id)
        {
            ...
            {
                TempData["error"] = $"{model.Name} isimli bir Kategori bir yada daha fazla kayıt ile ilişkili olduğu için silinememiştir!";
